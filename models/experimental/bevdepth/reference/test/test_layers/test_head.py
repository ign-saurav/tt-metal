...
class TestLSSFPN(unittest.TestCase):
    def setUp(self) -> None:
        ...
        bev_neck = dict(
            type="SECONDFPN", in_channels=[10, 20, 40, 80], upsample_strides=[1, 2, 4, 8], out_channels=[8, 8, 8, 8]
        )
    ...
    def test_get_targets(self):
        ...
        heatmaps, anno_boxes, inds, masks = self.bevdet_head.get_targets(gt_boxes_3d, gt_labels_3d)
