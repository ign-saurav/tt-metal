...
from models.experimental.bevdepth.reference.bevdepth.datasets.ext_loader import ext_loader

ext_module = ext_loader.load_ext("_ext", ["box_iou_rotated"])


def box_iou_rotated(
    bboxes1: torch.Tensor, bboxes2: torch.Tensor, mode: str = "iou", aligned: bool = False, clockwise: bool = True
) -> torch.Tensor:
