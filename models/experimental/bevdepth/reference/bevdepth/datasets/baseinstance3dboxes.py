...
from models.experimental.bevdepth.reference.bevdepth.datasets.basepoints import BasePoints
from models.experimental.bevdepth.reference.bevdepth.datasets.utils import limit_period
...
class BaseInstance3DBoxes:
    ...
    def cuda(self, *args, **kwargs) -> "BaseInstance3DBoxes":
        ...
        """
        original_type = type(self)
        return original_type(self.tensor.cuda(*args, **kwargs), box_dim=self.box_dim, with_yaw=self.with_yaw)
    ...
    def height_overlaps(cls, boxes1: "BaseInstance3DBoxes", boxes2: "BaseInstance3DBoxes") -> Tensor:
        ...
        assert type(boxes1) == type(boxes2), (
            '"boxes1" and "boxes2" should be in the same type, ' f"but got {type(boxes1)} and {type(boxes2)}."
        )
    ...
    def points_in_boxes(self, points: Tensor, boxes_override: Optional[Tensor] = None) -> Tensor:
        warnings.warn(
            "DeprecationWarning: points_in_boxes is a deprecated " "method, please consider using points_in_boxes_part."
        )
