...
class BEVDepthLightningModel(BaseBEVDepthLightningModel):
    def __init__(self, **kwargs):
        ...
        self.sweep_idxes = [4]
        self.head_conf["bev_backbone_conf"]["in_channels"] = 80 * (len(self.sweep_idxes) + 1)
        self.head_conf["bev_neck_conf"]["in_channels"] = [80 * (len(self.sweep_idxes) + 1), 160, 320, 640]
...
if __name__ == "__main__":
    run_cli(BEVDepthLightningModel, "bev_depth_fusion_lss_r50_256x704_128x128_24e_key4")
