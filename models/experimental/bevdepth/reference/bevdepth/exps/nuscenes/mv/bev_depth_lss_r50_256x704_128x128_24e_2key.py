...
"""
from models.experimental.bevdepth.reference.bevdepth.exps.base_cli import run_cli
...
if __name__ == "__main__":
    run_cli(BEVDepthLightningModel, "bev_depth_lss_r50_256x704_128x128_24e_2key")
