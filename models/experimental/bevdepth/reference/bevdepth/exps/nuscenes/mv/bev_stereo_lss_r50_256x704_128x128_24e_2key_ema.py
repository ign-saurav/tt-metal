...
from bevdepth.exps.nuscenes.mv.bev_stereo_lss_r50_256x704_128x128_24e_2key import BEVDepthLightningModel  # noqa

if __name__ == "__main__":
    run_cli(BEVDepthLightningModel, "bev_stereo_lss_r50_256x704_128x128_24e_2key_ema", use_ema=True)
