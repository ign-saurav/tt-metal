...
from models.experimental.bevdepth.reference.bevdepth.callbacks.ema import EMACallback
...
def run_cli(model_class=BEVDepthLightningModel, exp_name="base_exp", use_ema=False, extra_trainer_config_args={}):
    ...
    parent_parser.add_argument(
        "-p", "--predict", dest="predict", action="store_true", help="predict model on testing set"
    )
