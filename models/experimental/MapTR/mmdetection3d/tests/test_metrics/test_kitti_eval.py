...
def test_do_eval():
    ...
    min_overlaps = np.array(
        [[[0.5, 0.5, 0.7], [0.5, 0.5, 0.7], [0.5, 0.5, 0.7]], [[0.5, 0.5, 0.7], [0.25, 0.25, 0.5], [0.25, 0.25, 0.5]]]
    )
    eval_types = ["bbox", "bev", "3d", "aos"]
    mAP_bbox, mAP_bev, mAP_3d, mAP_aos = do_eval([gt_anno], [dt_anno], current_classes, min_overlaps, eval_types)
    expected_mAP_bbox = np.array(
        [
            [[0.0, 0.0], [9.09090909, 9.09090909], [9.09090909, 9.09090909]],
            [[0.0, 0.0], [9.09090909, 9.09090909], [9.09090909, 9.09090909]],
            [[0.0, 0.0], [9.09090909, 9.09090909], [9.09090909, 9.09090909]],
        ]
    )
    expected_mAP_bev = np.array(
        [
    ...
    expected_mAP_aos = np.array(
        [
            [[0.0, 0.0], [0.55020816, 0.55020816], [0.55020816, 0.55020816]],
            [[0.0, 0.0], [8.36633862, 8.36633862], [8.36633862, 8.36633862]],
            [[0.0, 0.0], [8.63476893, 8.63476893], [8.63476893, 8.63476893]],
        ]
    )
...
def test_eval_class():
    ...
    dt_score = np.array([0.18151495, 0.57920843, 0.27795696, 0.23100418, 0.21541929])
    dt_anno = dict(
        name=dt_name, truncated=dt_truncated, occluded=dt_occluded, alpha=dt_alpha, bbox=dt_bbox, score=dt_score
    )
    current_classes = [1, 2, 0]
    difficultys = [0, 1, 2]
    metric = 0
