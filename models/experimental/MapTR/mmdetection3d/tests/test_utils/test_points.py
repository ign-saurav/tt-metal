...
def test_base_points():
    ...
    points_np = np.array(
        [
            [-5.24223238e00, 4.00209696e01, 2.97570381e-01],
            [-2.66751588e01, 5.59499564e00, -9.14345860e-01],
            [-5.80979675e00, 3.54092357e01, 2.00889888e-01],
            [-3.13086877e01, 1.09007628e00, -1.94612112e-01],
        ],
        dtype=np.float32,
    )
    ...
    expected_tensor = torch.tensor(
        [
            [6.6239e00, 3.9748e01, -2.3335e00, 6.6660e-01, 1.9560e-01, 4.9740e-01, 9.4090e-01],
            [-2.3174e01, 1.2600e01, -6.9230e00, 1.5020e-01, 3.7070e-01, 1.0860e-01, 6.2970e-01],
            [4.7760e00, 3.5484e01, -2.3813e00, 6.5650e-01, 6.2480e-01, 6.9540e-01, 2.5380e-01],
            [-2.8960e01, 9.6364e00, -7.0663e00, 2.8030e-01, 2.5800e-02, 4.8960e-01, 3.2690e-01],
        ]
    )
    ...
    expected_tensor = torch.tensor(
        [
            [2.6226e00, 4.0211e01, -2.3335e00, 6.6660e-01, 1.9560e-01, 4.9740e-01, 9.4090e-01],
            [-2.4316e01, 1.0224e01, -6.9230e00, 1.5020e-01, 3.7070e-01, 1.0860e-01, 6.2970e-01],
            [1.2096e00, 3.5784e01, -2.3813e00, 6.5650e-01, 6.2480e-01, 6.9540e-01, 2.5380e-01],
            [-2.9777e01, 6.6971e00, -7.0663e00, 2.8030e-01, 2.5800e-02, 4.8960e-01, 3.2690e-01],
        ]
    )
    ...
    expected_tensor = torch.tensor(
        [
            [7.5602e00, 3.9473e01, -2.1152e00, 6.6660e-01, 1.9560e-01, 4.9740e-01, 9.4090e-01],
            [-2.2237e01, 1.2325e01, -6.7046e00, 1.5020e-01, 3.7070e-01, 1.0860e-01, 6.2970e-01],
            [5.7123e00, 3.5209e01, -2.1629e00, 6.5650e-01, 6.2480e-01, 6.9540e-01, 2.5380e-01],
            [-2.8023e01, 9.3613e00, -6.8480e00, 2.8030e-01, 2.5800e-02, 4.8960e-01, 3.2690e-01],
        ]
    )
    ...
    expected_tensor = torch.tensor(
        [
            [9.0722e00, 4.7368e01, -2.5382e00, 6.6660e-01, 1.9560e-01, 4.9740e-01, 9.4090e-01],
            [-2.6685e01, 1.4790e01, -8.0455e00, 1.5020e-01, 3.7070e-01, 1.0860e-01, 6.2970e-01],
            [6.8547e00, 4.2251e01, -2.5955e00, 6.5650e-01, 6.2480e-01, 6.9540e-01, 2.5380e-01],
            [-3.3628e01, 1.1234e01, -8.2176e00, 2.8030e-01, 2.5800e-02, 4.8960e-01, 3.2690e-01],
        ]
    )
    assert torch.allclose(expected_tensor, base_points.tensor, 1e-3)
    ...
    assert torch.allclose(
        base_points.color,
        torch.tensor(
            [[0.1956, 0.4974, 0.9409], [0.3707, 0.1086, 0.6297], [0.6248, 0.6954, 0.2538], [0.0258, 0.4896, 0.3269]]
        ),
    )
