...
from mmdet3d.core.bbox import CameraInstance3DBoxes, Coord3DMode, DepthInstance3DBoxes, LiDARInstance3DBoxes
...
def test_points_conversion():
    ...
    points_np = np.array(
        [
            [-5.24223238e00, 4.00209696e01, 2.97570381e-01, 0.6666, 0.1956, 0.4974, 0.9409],
            [-2.66751588e01, 5.59499564e00, -9.14345860e-01, 0.1502, 0.3707, 0.1086, 0.6297],
            [-5.80979675e00, 3.54092357e01, 2.00889888e-01, 0.6565, 0.6248, 0.6954, 0.2538],
            [-3.13086877e01, 1.09007628e00, -1.94612112e-01, 0.2803, 0.0258, 0.4896, 0.3269],
        ],
        dtype=np.float32,
    )
    ...
    expected_tensor = torch.tensor(
        [
            [2.9757e-01, 5.2422e00, -4.0021e01, 6.6660e-01, 1.9560e-01, 4.9740e-01, 9.4090e-01],
            [-9.1435e-01, 2.6675e01, -5.5950e00, 1.5020e-01, 3.7070e-01, 1.0860e-01, 6.2970e-01],
            [2.0089e-01, 5.8098e00, -3.5409e01, 6.5650e-01, 6.2480e-01, 6.9540e-01, 2.5380e-01],
            [-1.9461e-01, 3.1309e01, -1.0901e00, 2.8030e-01, 2.5800e-02, 4.8960e-01, 3.2690e-01],
        ]
    )
    ...
    assert torch.allclose(lidar_point_tensor, convert_lidar_points.tensor, 1e-4)

    convert_depth_points = cam_points.convert_to(Coord3DMode.DEPTH)
    expected_tensor = torch.tensor(
        [
            [-5.2422e00, 2.9757e-01, -4.0021e01, 6.6660e-01, 1.9560e-01, 4.9740e-01, 9.4090e-01],
            [-2.6675e01, -9.1435e-01, -5.5950e00, 1.5020e-01, 3.7070e-01, 1.0860e-01, 6.2970e-01],
            [-5.8098e00, 2.0089e-01, -3.5409e01, 6.5650e-01, 6.2480e-01, 6.9540e-01, 2.5380e-01],
            [-3.1309e01, -1.9461e-01, -1.0901e00, 2.8030e-01, 2.5800e-02, 4.8960e-01, 3.2690e-01],
        ]
    )
    ...
    assert torch.allclose(depth_point_tensor, convert_depth_points.tensor, 1e-4)
    ...
    expected_tensor = torch.tensor(
        [
            [-4.0021e01, -2.9757e-01, -5.2422e00, 6.6660e-01, 1.9560e-01, 4.9740e-01, 9.4090e-01],
            [-5.5950e00, 9.1435e-01, -2.6675e01, 1.5020e-01, 3.7070e-01, 1.0860e-01, 6.2970e-01],
            [-3.5409e01, -2.0089e-01, -5.8098e00, 6.5650e-01, 6.2480e-01, 6.9540e-01, 2.5380e-01],
            [-1.0901e00, 1.9461e-01, -3.1309e01, 2.8030e-01, 2.5800e-02, 4.8960e-01, 3.2690e-01],
        ]
    )
    ...
    expected_tensor = torch.tensor(
        [
            [-4.0021e01, -5.2422e00, 2.9757e-01, 6.6660e-01, 1.9560e-01, 4.9740e-01, 9.4090e-01],
            [-5.5950e00, -2.6675e01, -9.1435e-01, 1.5020e-01, 3.7070e-01, 1.0860e-01, 6.2970e-01],
            [-3.5409e01, -5.8098e00, 2.0089e-01, 6.5650e-01, 6.2480e-01, 6.9540e-01, 2.5380e-01],
            [-1.0901e00, -3.1309e01, -1.9461e-01, 2.8030e-01, 2.5800e-02, 4.8960e-01, 3.2690e-01],
        ]
    )
    ...
    rt_mat_provided = torch.tensor(
        [[0.99789, -0.012698, -0.063678], [-0.012698, 0.92359, -0.38316], [0.063678, 0.38316, 0.92148]]
    )
    ...
    cam_point_tensor_new = Coord3DMode.convert_point(
        depth_points_new, Coord3DMode.DEPTH, Coord3DMode.CAM, rt_mat=rt_mat_provided
    )
