...
from mmdet3d.core.bbox.structures.utils import (
    get_box_type,
    limit_period,
    points_cam2img,
    rotation_3d_in_axis,
...
def test_lidar_boxes3d():
    ...
    th_boxes = torch.tensor(
        [
            [28.29669987, -0.5557558, -1.30332506, 1.47000003, 2.23000002, 1.48000002, -1.57000005],
            [26.66901946, 21.82302134, -1.73605708, 1.55999994, 3.48000002, 1.39999998, -1.69000006],
            [31.31977974, 8.16214412, -1.62177875, 1.74000001, 3.76999998, 1.48000002, 2.78999996],
        ],
        dtype=torch.float32,
    )
    ...
    expected_rot_mat_T = torch.tensor([[0.9908, -0.1356, 0.0000], [0.1356, 0.9908, 0.0000], [0.0000, 0.0000, 1.0000]])
    ...
    points_np = np.array(
        [
            [-1.0280, 0.9888, -1.4658],
            [-4.3695, 2.1310, -1.3857],
            [-6.5263, 1.5595, -0.9697],
            [-0.4809, 0.7073, -0.5265],
            [-4.5623, 0.7166, -1.4741],
        ]
    )
    points_np, rot_mat_T_np = boxes.rotate(0.13603681398218053, points_np)
    expected_points_np = np.array(
        [
            [-0.8844, 1.1191, -1.4658],
    ...
    expected_rot_mat_T_np = np.array([[0.9908, -0.1356, 0.0000], [0.1356, 0.9908, 0.0000], [0.0000, 0.0000, 1.0000]])
    ...
    expected_tensor = torch.tensor(
        [
            [1.0443488, -2.9183323, -1.7599131, 1.7597977, 3.4089797, 1.6592377, 1.9336663],
            [8.014273, -4.8007393, -1.6448704, 1.5486219, 4.0324507, 1.57879, 1.7936664],
            [27.558605, -7.1084175, -1.310622, 1.4782301, 2.242485, 1.488286, 4.9836664],
            [19.934517, -28.344835, -1.7457767, 1.5687338, 3.4994833, 1.4078381, 5.1036663],
            [28.130915, -16.369587, -1.6308585, 1.7497417, 3.791107, 1.488286, 0.6236664],
        ]
    )
    ...
    expected_tensor = torch.tensor(
        [
            [1.1281544, -3.0507944, -1.9169292, 1.7597977, 3.4089797, 1.6592377, 1.9336663],
            [8.098079, -4.9332013, -1.8018866, 1.5486219, 4.0324507, 1.57879, 1.7936664],
            [27.64241, -7.2408795, -1.4676381, 1.4782301, 2.242485, 1.488286, 4.9836664],
            [20.018322, -28.477297, -1.9027928, 1.5687338, 3.4994833, 1.4078381, 5.1036663],
            [28.21472, -16.502048, -1.7878747, 1.7497417, 3.791107, 1.488286, 0.6236664],
        ]
    )
    ...
    index_boxes = boxes[2]
    expected_tensor = torch.tensor([[27.64241, -7.2408795, -1.4676381, 1.4782301, 2.242485, 1.488286, 4.9836664]])
    ...
    expected_tensor = boxes.tensor[:, :3] - boxes.tensor[:, 3:6] * (
    ...
    assert torch.allclose(boxes.nearest_bev, expected_tensor, rtol=1e-4, atol=1e-7)

    # obtained by the print of the original implementation
    expected_tensor = torch.tensor(
        [
            [
                [2.4093e00, -4.4784e00, -1.9169e00],
                [2.4093e00, -4.4784e00, -2.5769e-01],
                [-7.7767e-01, -3.2684e00, -2.5769e-01],
                [-7.7767e-01, -3.2684e00, -1.9169e00],
                [3.0340e00, -2.8332e00, -1.9169e00],
                [3.0340e00, -2.8332e00, -2.5769e-01],
                [-1.5301e-01, -1.6232e00, -2.5769e-01],
                [-1.5301e-01, -1.6232e00, -1.9169e00],
            ],
            [
                [9.8933e00, -6.1340e00, -1.8019e00],
                [9.8933e00, -6.1340e00, -2.2310e-01],
                [5.9606e00, -5.2427e00, -2.2310e-01],
                [5.9606e00, -5.2427e00, -1.8019e00],
                [1.0236e01, -4.6237e00, -1.8019e00],
                [1.0236e01, -4.6237e00, -2.2310e-01],
                [6.3029e00, -3.7324e00, -2.2310e-01],
                [6.3029e00, -3.7324e00, -1.8019e00],
            ],
            [
                [2.8525e01, -8.2534e00, -1.4676e00],
                [2.8525e01, -8.2534e00, 2.0648e-02],
                [2.6364e01, -7.6525e00, 2.0648e-02],
                [2.6364e01, -7.6525e00, -1.4676e00],
                [2.8921e01, -6.8292e00, -1.4676e00],
                [2.8921e01, -6.8292e00, 2.0648e-02],
                [2.6760e01, -6.2283e00, 2.0648e-02],
                [2.6760e01, -6.2283e00, -1.4676e00],
            ],
            [
                [2.1337e01, -2.9870e01, -1.9028e00],
                [2.1337e01, -2.9870e01, -4.9495e-01],
                [1.8102e01, -2.8535e01, -4.9495e-01],
                [1.8102e01, -2.8535e01, -1.9028e00],
                [2.1935e01, -2.8420e01, -1.9028e00],
                [2.1935e01, -2.8420e01, -4.9495e-01],
                [1.8700e01, -2.7085e01, -4.9495e-01],
                [1.8700e01, -2.7085e01, -1.9028e00],
            ],
            [
                [2.6398e01, -1.7530e01, -1.7879e00],
                [2.6398e01, -1.7530e01, -2.9959e-01],
                [2.8612e01, -1.4452e01, -2.9959e-01],
                [2.8612e01, -1.4452e01, -1.7879e00],
                [2.7818e01, -1.8552e01, -1.7879e00],
                [2.7818e01, -1.8552e01, -2.9959e-01],
                [3.0032e01, -1.5474e01, -2.9959e-01],
                [3.0032e01, -1.5474e01, -1.7879e00],
            ],
        ]
    )
    # the pytorch print loses some precision
...
def test_boxes_conversion():
    ...
    expected_tensor = torch.tensor(
        [
            ...
            [7.05006905e00, -6.57459601e00, -1.60107949e00, 2.27999997e00, 1.27799997e01, 3.66000009e00, 1.54999995e00],
            [2.24698818e01, -6.69203759e00, -1.50118145e00, 2.31999993e00, 1.47299995e01, 3.64000010e00, 1.59000003e00],
            [3.48291965e01, -7.09058388e00, -1.36622983e00, 2.31999993e00, 1.00400000e01, 3.60999990e00, 1.61000001e00],
            [4.62394617e01, -7.75838800e00, -1.32405020e00, 2.33999991e00, 1.28299999e01, 3.63000011e00, 1.63999999e00],
        ],
        dtype=torch.float32,
    )
    ...
    cam_to_lidar_box = Box3DMode.convert(
        camera_boxes.tensor.numpy(), Box3DMode.CAM, Box3DMode.LIDAR, rt_mat.inverse().numpy()
    )
    assert np.allclose(cam_to_lidar_box, expected_tensor.numpy())

    # test list convert
    cam_to_lidar_box = Box3DMode.convert(
        camera_boxes.tensor[0].numpy().tolist(), Box3DMode.CAM, Box3DMode.LIDAR, rt_mat.inverse().numpy()
    )
...
def test_camera_boxes3d():
    ...
    expected_rot_mat_T = torch.tensor([[0.9908, 0.0000, -0.1356], [0.0000, 1.0000, 0.0000], [0.1356, 0.0000, 0.9908]])
    assert torch.allclose(boxes.tensor, expected_tensor, 1e-3)
    assert torch.allclose(points, expected_points, 1e-3)
    assert torch.allclose(rot_mat_T, expected_rot_mat_T, 1e-3)

    # with input torch.Tensor points and rotation matrix
    points, rot_mat_T = boxes.rotate(torch.tensor(-0.13603681398218053), points)  # back
    ...
    points_np, rot_mat_T_np = boxes.rotate(torch.tensor(0.13603681398218053), points_np)
    expected_points_np = np.array(
        [
            [0.4712, 1.2559, -1.5440, 2.5359],
    ...
    expected_rot_mat_T_np = np.array([[0.9908, 0.0000, -0.1356], [0.0000, 1.0000, 0.0000], [0.1356, 0.0000, 0.9908]])
    ...
    expected_tensor = torch.tensor(
        [
            [
                [3.2684e00, 2.5769e-01, -7.7767e-01],
                [1.6232e00, 2.5769e-01, -1.5301e-01],
                [1.6232e00, 1.9169e00, -1.5301e-01],
                [3.2684e00, 1.9169e00, -7.7767e-01],
                [4.4784e00, 2.5769e-01, 2.4093e00],
                [2.8332e00, 2.5769e-01, 3.0340e00],
                [2.8332e00, 1.9169e00, 3.0340e00],
                [4.4784e00, 1.9169e00, 2.4093e00],
            ],
            [
                [5.2427e00, 2.2310e-01, 5.9606e00],
                [3.7324e00, 2.2310e-01, 6.3029e00],
                [3.7324e00, 1.8019e00, 6.3029e00],
                [5.2427e00, 1.8019e00, 5.9606e00],
                [6.1340e00, 2.2310e-01, 9.8933e00],
                [4.6237e00, 2.2310e-01, 1.0236e01],
                [4.6237e00, 1.8019e00, 1.0236e01],
                [6.1340e00, 1.8019e00, 9.8933e00],
            ],
            [
                [7.6525e00, -2.0648e-02, 2.6364e01],
                [6.2283e00, -2.0648e-02, 2.6760e01],
                [6.2283e00, 1.4676e00, 2.6760e01],
                [7.6525e00, 1.4676e00, 2.6364e01],
                [8.2534e00, -2.0648e-02, 2.8525e01],
                [6.8292e00, -2.0648e-02, 2.8921e01],
                [6.8292e00, 1.4676e00, 2.8921e01],
                [8.2534e00, 1.4676e00, 2.8525e01],
            ],
            [
                [2.8535e01, 4.9495e-01, 1.8102e01],
                [2.7085e01, 4.9495e-01, 1.8700e01],
                [2.7085e01, 1.9028e00, 1.8700e01],
                [2.8535e01, 1.9028e00, 1.8102e01],
                [2.9870e01, 4.9495e-01, 2.1337e01],
                [2.8420e01, 4.9495e-01, 2.1935e01],
                [2.8420e01, 1.9028e00, 2.1935e01],
                [2.9870e01, 1.9028e00, 2.1337e01],
            ],
            [
                [1.4452e01, 2.9959e-01, 2.8612e01],
                [1.5474e01, 2.9959e-01, 3.0032e01],
                [1.5474e01, 1.7879e00, 3.0032e01],
                [1.4452e01, 1.7879e00, 2.8612e01],
                [1.7530e01, 2.9959e-01, 2.6398e01],
                [1.8552e01, 2.9959e-01, 2.7818e01],
                [1.8552e01, 1.7879e00, 2.7818e01],
                [1.7530e01, 1.7879e00, 2.6398e01],
            ],
        ]
    )
    ...
    expected_tensor[:, :3] = th_boxes[:, :3] + th_boxes[:, 3:6] * (
        th_boxes.new_tensor((0.5, 1.0, 0.5)) - th_boxes.new_tensor((0.5, 0.5, 0.5))
    )
...
def test_boxes3d_overlaps():
    ...
    expected_iou_tensor = torch.tensor(
        [
            [0.3710, 0.0000, 0.0000, 0.0000],
            [0.0000, 0.3322, 0.0000, 0.0000],
    ...
    assert torch.allclose(expected_iou_tensor, overlaps_3d_iou, rtol=1e-4, atol=1e-7)

    expected_iof_tensor = torch.tensor(
        [
            [0.5582, 0.0000, 0.0000, 0.0000],
            [0.0000, 0.5025, 0.0000, 0.0000],
            [0.0000, 0.0000, 0.0000, 0.0000],
            [0.0000, 0.0000, 1.0000, 0.0000],
        ],
        device="cuda",
    ...
    assert torch.allclose(expected_iof_tensor, overlaps_3d_iof, rtol=1e-4, atol=1e-7)
    ...
    assert torch.allclose(expected_iou_tensor, cam_overlaps_3d, rtol=1e-4, atol=1e-7)
...
def test_depth_boxes3d():
    ...
    expected_rot_mat_T = torch.tensor([[0.9997, -0.0230, 0.0000], [0.0230, 0.9997, 0.0000], [0.0000, 0.0000, 1.0000]])
    ...
    expected_rot_mat_T_np = np.array([[0.9997, -0.0230, 0.0000], [0.0230, 0.9997, 0.0000], [0.0000, 0.0000, 1.0000]])
    expected_tensor = torch.tensor(
        [
            [-1.5434, -2.4951, -0.5570, 0.9385, 2.1404, 0.8954, -0.0585],
            [-2.4016, -3.2521, 0.4426, 0.8234, 0.5325, 1.0099, -0.1215],
    ...
    expected_tensor = torch.tensor(
        [
            [0.64884546, 0.78390356, 0.10563634, 1.50373348, 0.23795205, 0.27956772, 0],
            [1.45139421, 0.43169443, 0.93829232, 0.11967964, 0.93380373, 1.89191735, 0],
        ]
    )
    boxes_3 = boxes.clone()
    ...
    expected_surface_center = torch.tensor(
        [
            [0.3294, 1.0359, 0.8031],
...
def test_rotation_3d_in_axis():
    points = torch.tensor(
        [
            [[-0.4599, -0.0471, 0.0000], [-0.4599, -0.0471, 1.8433], [-0.4599, 0.0471, 1.8433]],
            [[-0.2555, -0.2683, 0.0000], [-0.2555, -0.2683, 0.9072], [-0.2555, 0.2683, 0.9072]],
        ]
    )
    rotated = rotation_3d_in_axis(points, torch.tensor([-np.pi / 10, np.pi / 10]), axis=0)
    expected_rotated = torch.tensor(
        [
            [[0.0000, -0.4228, -0.1869], [1.8433, -0.4228, -0.1869], [1.8433, -0.4519, -0.0973]],
            [[0.0000, -0.3259, -0.1762], [0.9072, -0.3259, -0.1762], [0.9072, -0.1601, 0.3341]],
        ]
    )
...
def test_limit_period():
    ...
    expected_result = torch.tensor([[0.4963], [0.7682], [0.0885], [0.1320], [0.3074]])
...
def test_xywhr2xyxyr():
    ...
    expected_xyxyr = torch.tensor(
        [[-0.5000, 0.0000, 2.5000, 4.0000, 5.0000], [-1.0000, -0.5000, 1.0000, 2.5000, 4.0000]]
    )
...
def test_points_cam2img():
    ...
    expected_point_2d_res = torch.tensor(
        [[0.5832, 0.6496], [0.6146, 0.7910], [0.6994, 0.7782], [0.5623, 0.6303], [0.4359, 0.6532]]
    )
