...
def test_merge_aug_bboxes_3d():
    ...
    aug_result = dict(boxes_3d=boxes_3d, labels_3d=labels_3d, scores_3d=scores_3d)
    ...
    expected_scores_3d = torch.tensor([1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 0.5000, 0.5000, 0.5000])
