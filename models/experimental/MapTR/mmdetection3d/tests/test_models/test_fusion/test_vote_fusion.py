...
def test_vote_fusion():
    img_meta = {
        ...
        "pcd_rotation": torch.tensor([[0.9747, 0.2234, 0.0000], [-0.2234, 0.9747, 0.0000], [0.0000, 0.0000, 1.0000]]),
        "transformation_3d_flow": ["HF", "R", "S", "T"],
    }

    rt_mat = torch.tensor(
        [[0.979570, 0.047954, -0.195330], [0.047954, 0.887470, 0.458370], [0.195330, -0.458370, 0.867030]]
    )
    k_mat = torch.tensor([[529.5000, 0.0000, 365.0000], [0.0000, 529.5000, 265.0000], [0.0000, 0.0000, 1.0000]])
