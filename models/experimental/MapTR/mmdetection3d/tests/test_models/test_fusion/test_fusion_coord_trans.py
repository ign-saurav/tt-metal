...
def test_coords_transformation():
    ...
    pcd = torch.tensor(
        [[-5.2422e00, -2.9757e-01, 4.0021e01], [-9.1435e01, 2.6675e01, -5.5950e00], [6.061661e00, -0.0, -1.0e02]]
    )
    ...
    pcd = torch.tensor(
        [[-5.2422e00, 4.0021e01, -2.9757e-01], [-9.1435e01, -5.5950e00, 2.6675e01], [6.061661e00, -1.0e02, -0.0]]
    )
