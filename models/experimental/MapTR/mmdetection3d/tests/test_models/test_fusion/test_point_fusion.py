...
def test_sample_single():
    ...
    lidar2img = torch.tensor(
        [
            [6.0294e02, -7.0791e02, -1.2275e01, -1.7094e02],
            [1.7678e02, 8.8088e00, -7.0794e02, -1.0257e02],
    ...
    pts = torch.tensor(
        [[8.356, -4.312, -0.445], [11.777, -6.724, -0.564], [6.453, 2.53, -1.612], [6.227, -3.839, -0.563]]
    )
    ...
    pcd_rotation = torch.tensor([[8.660254e-01, 0.5, 0], [-0.5, 8.660254e-01, 0], [0, 0, 1.0e00]])
