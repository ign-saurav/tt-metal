...
def test_outdoor_velocity_aug_pipeline():
    ...
    gt_bboxes_3d = LiDARInstance3DBoxes(
        torch.tensor(
            [
                ...
                [-5.8098e00, 3.5409e01, -6.6511e-01, 2.3960e00, 3.9690e00, 1.7320e00, -4.6520e00, 0.0000e00, 0.0000e00],
                [
                    -3.1309e01,
                    1.0901e00,
                    -1.0561e00,
                ...
                [-4.5642e01, 2.0136e01, -2.4681e-02, 1.9870e00, 4.4400e00, 1.9420e00, 2.8336e-01, 0.0000e00, 0.0000e00],
                [-5.1617e00, 1.8305e01, -1.0879e00, 2.3230e00, 4.8510e00, 1.3710e00, -1.5803e00, 0.0000e00, 0.0000e00],
                [
                    -2.5285e01,
                    4.1442e00,
                    -1.2713e00,
                ...
                [-6.5878e01, 1.3500e01, -2.2528e-01, 1.8200e00, 3.8520e00, 1.5450e00, -2.8757e00, 0.0000e00, 0.0000e00],
                [
                    -5.4490e00,
                    2.8363e01,
                    -7.7275e-01,
    ...
    expected_tensor = torch.tensor(
        [
            [-3.7849e00, -4.1057e01, -4.8668e-01, 2.1064e00, 4.5039e00, 1.5813e00, -1.6919e00, 1.0469e-02, -4.5533e-02],
            [
                -2.7010e01,
                -6.7551e00,
                -1.3334e00,
            ...
            [-4.5448e00, -3.6372e01, -6.7942e-01, 2.4476e00, 4.0544e00, 1.7693e00, 1.4721e00, 0.0000e00, -0.0000e00],
            [-3.1916e01, -2.3379e00, -1.0788e00, 1.9858e00, 3.9400e00, 1.7601e00, -3.6564e-01, -3.1333e-02, 8.1166e-02],
            [-4.5802e01, -2.2340e01, -2.5213e-02, 2.0298e00, 4.5355e00, 1.9838e00, 2.8199e00, 0.0000e00, -0.0000e00],
            [-4.5526e00, -1.8887e01, -1.1114e00, 2.3730e00, 4.9554e00, 1.4005e00, -1.5997e00, 0.0000e00, -0.0000e00],
            [-2.5648e01, -5.2197e00, -1.2987e00, 1.7928e00, 2.0318e00, 2.2678e00, 1.3100e00, -3.8428e-02, 1.5485e-01],
            [-1.5578e00, -1.9657e01, -1.1699e00, 9.3878e-01, 1.1472e00, 1.9726e00, 3.0555e00, 4.5907e-04, 1.7928e00],
            [-4.4522e00, -2.9166e01, -7.8938e-01, 2.2841e00, 3.8348e00, 1.5925e00, 1.4721e00, -7.8371e-03, -8.1931e-03],
        ]
    )
    assert torch.allclose(output["gt_bboxes_3d"]._data.tensor, expected_tensor, atol=1e-3)
