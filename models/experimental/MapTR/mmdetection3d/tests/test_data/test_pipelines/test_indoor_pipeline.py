...
def test_scannet_pipeline():
    ...
    pipelines = [
        ...
        dict(
            type="Collect3D", keys=["points", "gt_bboxes_3d", "gt_labels_3d", "pts_semantic_mask", "pts_instance_mask"]
        ),
    ]
...
def test_scannet_seg_pipeline():
    ...
    expected_points = np.concatenate(
        [
            ...
            scannet_points[scannet_choices, 3:] / 255.0,
...
def test_s3dis_seg_pipeline():
    ...
    expected_points = np.concatenate(
        [
            ...
            s3dis_points[s3dis_choices, 3:] / 255.0,
