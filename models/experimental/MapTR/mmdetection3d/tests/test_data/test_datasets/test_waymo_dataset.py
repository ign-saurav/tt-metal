...
def test_getitem():
    ...
    expected_gt_bboxes_3d = torch.tensor([[31.4750, -4.5690, 2.1857, 2.3519, 6.0931, 3.1756, -1.2895]])
...
def test_evaluate():
    ...
    boxes_3d = LiDARInstance3DBoxes(
        torch.tensor([[6.9684e01, 3.3335e01, 4.1465e-02, 2.0100e00, 4.3600e00, 1.4600e00, -9.0000e-02]])
    )
