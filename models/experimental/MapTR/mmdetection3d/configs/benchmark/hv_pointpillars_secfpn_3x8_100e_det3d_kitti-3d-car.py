...
model = dict(
    type="VoxelNet",
    voxel_layer=dict(
        max_num_points=64, point_cloud_range=point_cloud_range, voxel_size=voxel_size, max_voxels=(12000, 20000)
    ),
    voxel_encoder=dict(
...
optimizer = dict(type="AdamW", lr=lr, betas=(0.95, 0.99), weight_decay=0.01)  # the momentum is change during training
