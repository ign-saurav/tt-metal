_base_ = ["../_base_/models/3dssd.py", "../_base_/datasets/kitti-3d-car.py", "../_base_/default_runtime.py"]
...
train_pipeline = [
    ...
    dict(type="GlobalRotScaleTrans", rot_range=[-0.78539816, 0.78539816], scale_ratio_range=[0.9, 1.1]),
...
# model settings
model = dict(bbox_head=dict(num_classes=1, bbox_coder=dict(type="AnchorFreeBBoxCoder", num_dir_bins=12, with_rot=True)))
