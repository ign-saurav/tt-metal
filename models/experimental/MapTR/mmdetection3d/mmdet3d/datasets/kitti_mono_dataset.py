...
class KittiMonoDataset(NuScenesMonoDataset):
    ...
    def __init__(
        self, data_root, info_file, load_interval=1, with_velocity=False, eval_version=None, version=None, **kwargs
    ):
        super().__init__(
            data_root=data_root,
    ...
    def _parse_ann_info(self, img_info, ann_info):
        ...
        for i, ann in enumerate(ann_info):
            ...
            if ann.get("iscrowd", False):
                ...
                bbox_cam3d = np.array(ann["bbox_cam3d"]).reshape(
                    -1,
                )
    ...
    def evaluate(
        self, results, metric=None, logger=None, pklfile_prefix=None, submission_prefix=None, show=False, out_dir=None
    ):
