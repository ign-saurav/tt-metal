...
class WaymoDataset(KittiDataset):
    ...
    def format_results(self, outputs, pklfile_prefix=None, submission_prefix=None, data_format="waymo"):
        ...
        if "waymo" in data_format:
            from ..core.evaluation.waymo_utils.prediction_kitti_to_waymo import KITTI2Waymo  # noqa
            ...
            if "pts_bbox" in result_files:
                ...
                converter = KITTI2Waymo(
                    result_files, waymo_tfrecords_dir, waymo_results_save_dir, waymo_results_final_path, prefix
                )
            converter.convert()
    ...
    def evaluate(
        ...
        if "waymo" in metric:
            ...
            ap_dict["Overall/L1 mAP"] = (
                ap_dict["Vehicle/L1 mAP"] + ap_dict["Pedestrian/L1 mAP"] + ap_dict["Cyclist/L1 mAP"]
            ) / 3
            ap_dict["Overall/L1 mAPH"] = (
                ap_dict["Vehicle/L1 mAPH"] + ap_dict["Pedestrian/L1 mAPH"] + ap_dict["Cyclist/L1 mAPH"]
            ) / 3
            ap_dict["Overall/L2 mAP"] = (
                ap_dict["Vehicle/L2 mAP"] + ap_dict["Pedestrian/L2 mAP"] + ap_dict["Cyclist/L2 mAP"]
            ) / 3
            ap_dict["Overall/L2 mAPH"] = (
                ap_dict["Vehicle/L2 mAPH"] + ap_dict["Pedestrian/L2 mAPH"] + ap_dict["Cyclist/L2 mAPH"]
            ) / 3
