...
void three_nn_kernel_launcher(
    int b, int n, int m, const float* unknown, const float* known, float* dist2, int* idx, cudaStream_t stream);
...
void three_interpolate_kernel_launcher(
    int b,
    int c,
    int m,
    int n,
...
void three_interpolate_grad_wrapper(
    int b,
    int c,
    int n,
    int m,
...
void three_interpolate_grad_kernel_launcher(
    int b,
    int c,
    int n,
    int m,
