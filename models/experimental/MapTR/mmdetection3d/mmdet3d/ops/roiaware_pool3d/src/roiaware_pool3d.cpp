...
void roiaware_pool3d_backward_launcher(
    int boxes_num,
    int out_x,
    int out_y,
    int out_z,
...
int roiaware_pool3d_gpu_backward(
    at::Tensor pts_idx_of_voxels, at::Tensor argmax, at::Tensor grad_out, at::Tensor grad_in, int pool_method);
