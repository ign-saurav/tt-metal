...
def show_result(points, gt_bboxes, pred_bboxes, out_dir, filename, show=True, snapshot=False):
...
def show_seg_result(points, gt_seg, pred_seg, out_dir, filename, palette, ignore_index=None, show=True, snapshot=False):
    """Convert results into format that is directly readable for meshlab.
