...
class PartA2(TwoStage3DDetector):
    ...
    def extract_feat(self, points, img_metas):
        ...
        feats_dict = self.middle_encoder(voxel_features, voxel_dict["coors"], batch_size)
    ...
    def voxelize(self, points):
        ...
        voxel_dict = dict(voxels=voxels, num_points=num_points, coors=coors_batch, voxel_centers=voxel_centers)
        return voxel_dict
    ...
    def forward_train(self, points, img_metas, gt_bboxes_3d, gt_labels_3d, gt_bboxes_ignore=None, proposals=None):
        ...
        roi_losses = self.roi_head.forward_train(
            feats_dict, voxels_dict, img_metas, proposal_list, gt_bboxes_3d, gt_labels_3d
        )
    ...
    def simple_test(self, points, img_metas, proposals=None, rescale=False):
        ...
        return self.roi_head.simple_test(feats_dict, voxels_dict, img_metas, proposal_list)
