...
if __name__ == "__main__":
    nusc = NuScenes(version="v1.0-mini", dataroot="models/experimental/MapTR/data/nuscenes", verbose=True)
    # render_annotation('7603b030b42a4b1caa8c443ccc1a7d52')
    # bevformer_results = mmcv.load('test/maptr_tiny_r50_24e_bevformer/Mon_Jan_12_21_34_05_2026/nuscmap_results.json')
    with open("test/maptr_tiny_r50_24e_bevformer/Mon_Jan_12_21_34_05_2026/nuscmap_results.json", "r") as f:
