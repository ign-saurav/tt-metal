...
parser.add_argument(
    "--root-path", type=str, default="models/experimental/MapTR/data/nuscenes", help="specify the root path of dataset"
)
...
parser.add_argument(
    "--out-dir", type=str, default="models/experimental/MapTR/data/nuscenes", required="False", help="name of info pkl"
)
...
if __name__ == "__main__":
    ...
    #     kitti_data_prep(
    #         root_path=args.root_path, info_prefix=args.extra_tag, version=args.version, out_dir=args.out_dir
    #     )
