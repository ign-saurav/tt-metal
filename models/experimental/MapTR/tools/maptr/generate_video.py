    ...
    for file in file_list:
        ...
        if os.path.isdir(file_path):
            ...
            for cam in CAMS[:3]:
                ...
                cv2.putText(
                    cam_img, cam, (p1[0], p1[1] + h + 2), 0, lw / 3, txt_color, thickness=tf, lineType=cv2.LINE_AA
                )
            ...
            resized_map_img = cv2.putText(resized_map_img, "PRED", org, font, fontScale, color, thickness, cv2.LINE_AA)
            resized_gt_map_img = cv2.putText(
                resized_gt_map_img, "GT", org, font, fontScale, color, thickness, cv2.LINE_AA
            )
