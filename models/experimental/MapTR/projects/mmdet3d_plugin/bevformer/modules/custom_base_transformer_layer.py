...
from models.experimental.MapTR.dependency import ConfigDict
from models.experimental.MapTR.dependency import build_norm_layer
from models.experimental.MapTR.dependency import BaseModule, ModuleList
...
try:
    from models.experimental.MapTR.dependency import MultiScaleDeformableAttention  # noqa F401
...
from models.experimental.MapTR.dependency import build_feedforward_network, build_attention
...
class MyCustomBaseTransformerLayerWithoutSelfAttn(BaseModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        assert set(operation_order) & set(["norm", "ffn", "cross_attn"]) == set(operation_order), (
            f"The operation_order of"
            f" {self.__class__.__name__} should "
