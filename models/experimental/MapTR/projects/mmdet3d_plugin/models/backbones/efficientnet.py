...
from models.experimental.MapTR.dependency import ConvModule, DropPath

# from mmcv.runner import BaseModule, Sequential
from models.experimental.MapTR.dependency import BaseModule, Sequential

# from mmdet.models.builder import BACKBONES
from models.experimental.MapTR.dependency import BACKBONES
...
class EfficientNet(BaseModule):
    ...
    def __init__(
        ...
        if frozen_stages not in range(len(self.layer_setting) + 1):
            raise ValueError(
                "frozen_stages must be in range(0, " f"{len(self.layer_setting) + 1}). " f"But received {frozen_stages}"
            )
