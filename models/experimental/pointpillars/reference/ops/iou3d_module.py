...
#         dc = edge_p1 - edge_p2
#         dp = p1 - p2
#         n1 = torch.cross(edge_p1, edge_p2)
#         n2 = torch.cross(p1, p2)
#         n3 = 1.0 / torch.cross(dc, dp)
#         return torch.stack([(n1 * dp[0] - n2 * dc[0]) * n3,
#                            (n1 * dp[1] - n2 * dc[1]) * n3])
...
#                     output.append(intersection(previous, current, edge_p1, edge_p2))
