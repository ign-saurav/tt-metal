...
import numpy as np
import torch
from models.experimental.pointpillars.reference.process import limit_period, iou2d_nearest
    ...
    def get_multi_anchors(self, feature_map_size):
        ...
        for i in range(len(ranges)):
            anchors = self.get_anchors(
                feature_map_size=feature_map_size, anchor_range=ranges[i], anchor_size=sizes[i], rotations=rotations
            )
