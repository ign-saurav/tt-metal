...
def test_perf_device_bare_metal_bevdepth(batch_size, model_name, expected_perf):
    subdir = model_name
    num_iterations = 1
    margin = 0.04

    command = f"pytest models/experimental/pointpillars/tests/pcc/test_pointpillars.py"
