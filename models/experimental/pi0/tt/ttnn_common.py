...
def tensor_1d_to_2d_ttnn(
    ...
    Converts [features] -> [1, features] on device using PyTorch operations.
    Used for biases, layer norm weights, and other 1D tensors.
    ...
    # Reshape in PyTorch: [features] -> [1, features]
    tensor_reshaped = tensor.reshape(1, features)

    # Convert directly to TTNN with TILE_LAYOUT
    tensor_ttnn = ttnn.from_torch(
        tensor_reshaped,
        dtype=dtype,
        layout=ttnn.TILE_LAYOUT,
