...
@pytest.mark.parametrize(
    ...
    [
        (1, "ttnn_centernet", 92.3),
    ],
)
@pytest.mark.models_device_performance_bare_metal
def test_perf_device_bare_metal_centernet(batch_size, model_name, expected_perf):
    subdir = model_name
    num_iterations = 1
    margin = 0.1

    command = "pytest models/experimental/centernet/tests/pcc/test_dla_seg.py"
