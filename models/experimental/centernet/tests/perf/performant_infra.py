...
class CenterNetPerformantTestInfra:
    """Infrastructure for performing end-to-end CenterNet model performance tests."""
    ...
    def __call__(self, l1_input_tensor):
        ...
        input_for_model = ttnn.slice(input_for_model, [0, 0, 0, 0], [1, 512, 512, 3])

        # Run TTNN model forward pass
        tt_output = self.ttnn_model.forward(input_for_model)
