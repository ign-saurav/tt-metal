...
@pytest.mark.parametrize(
    ...
    [
        (1, "ttnn_transfuser", 28.1),
    ],
)
@pytest.mark.models_device_performance_bare_metal
def test_perf_device_bare_metal_transfuser(batch_size, model_name, expected_perf):
    subdir = model_name
    num_iterations = 1
    margin = 0.1

    command = "pytest models/experimental/transfuser/tests/pcc/test_lidar_center_net.py"
