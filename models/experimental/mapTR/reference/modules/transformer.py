...
class ConvFuser(nn.Sequential):
    ...
    Args:
        in_channels (List[int]): List of input channel sizes.
    ...
    def forward(self, inputs: List[torch.Tensor]) -> torch.Tensor:
        ...
        Args:
            inputs: List of feature tensors to fuse.
...
class MapTRPerceptionTransformer(nn.Module):
    """MapTR Perception Transformer for BEV feature generation and decoding (inference-only).

    Args:
        encoder (nn.Module): BEV encoder module.
    ...
    def __init__(
        ...
        self.use_attn_bev = hasattr(encoder, "layers")  # BEVFormerEncoder has layers
    ...
    def attn_bev_encode(
        ...
        **kwargs,
        ...
        """Encode BEV features using attention-based encoder.

        Args:
            mlvl_feats: Multi-level features from backbone.
        ...
        # Compute rotation angle and shift from ego motion
    ...
    def lss_bev_encode(
        ...
        **kwargs,
        ...
        Args:
            mlvl_feats: Multi-level features (single level for LSS).
            prev_bev: Previous BEV features (unused in LSS).

        Returns:
            BEV embeddings.
        """
        assert len(mlvl_feats) == 1, "LSS only supports single level features"
        images = mlvl_feats[0]
        img_metas = kwargs.get("img_metas", [])
    ...
    def forward(
        ...
        **kwargs,
        ...
        Args:
            ...
            object_query_embed: Object query embeddings with shape (num_query, embed_dims*2).
            bev_h: BEV height.
            bev_w: BEV width.
            grid_length: Grid length.
            bev_pos: BEV positional encoding.
        ...
        Returns:
            Tuple of:
                ...
                - inter_references_out: Intermediate reference points.
        """
        if grid_length is None:
            grid_length = [0.512, 0.512]
