...
int voxel_pooling_inference_forward_wrapper(
    ...
    at::Tensor depth_features_tensor,
    at::Tensor context_features_tensor,
...
int voxel_pooling_inference_forward_wrapper(
    ...
    if (depth_features_tensor.dtype() == at::kFloat) {
        ...
        const half* depth_features = (half*)depth_features_tensor.data_ptr<at::Half>();
        const half* context_features = (half*)context_features_tensor.data_ptr<at::Half>();
