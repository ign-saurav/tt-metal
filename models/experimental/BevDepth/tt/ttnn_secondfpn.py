...
class SECONDFPN_TTNN:
    def __init__(
        ...
        model_config=None,
        use_torch_conv_transpose=True,  # Flag to use PyTorch fallback for conv_transpose2d
    ):
        self.device = device
    ...
    def __call__(self, x, batch_size=1):
        ...
        for i in range(self.num_levels):
            ...
            if use_conv_transpose and self.use_torch_conv_transpose:
                # PyTorch fallback for conv_transpose2d
                ...
                if use_conv_transpose:
                    ...
                    feat, [out_h, out_w], [_, _] = ttnn.conv2d(
                        input_tensor=feat,
                        weight_tensor=weight_tensor,
                        bias_tensor=bias_tensor,
                        device=self.device,
