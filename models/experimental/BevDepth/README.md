...
- **Supported Input Resolution:** `(256, 640)` = (Height, Width)
...
To run perf test:
```
pytest models/experimental/BevDepth/tests/perf/test_bevdepth_perf.py::test_bevdepth_perf_single_device -s
pytest models/experimental/BevDepth/tests/perf/test_bevdepth_perf.py::test_bevdepth_perf_multi_device -s
```
This test validates BEVDepth on multiple devices using data parallelism with:
...
- **Input Resolution**: `(256, 640)` (Height, Width)
...
### Citation
If you use BEVDepth in your research, please cite:
```bibtex
