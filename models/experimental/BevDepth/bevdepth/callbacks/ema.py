...
class EMACallback(Callback):
    ...
    def on_fit_start(self, trainer, pl_module):
        ...
        trainer.ema_model = ModelEMA(trainer.model.module.module.model.cuda(), 0.9990)
    ...
    def on_train_epoch_end(self, trainer, pl_module) -> None:
        ...
        torch.save(checkpoint, os.path.join(trainer.log_dir, f"{trainer.current_epoch}.pth"))
