...
from models.experimental.miniCPMo.reference.image_processing_minicpmv import MiniCPMVImageProcessor
...
from models.experimental.miniCPMo.reference.configuration_minicpm import ConditionalChatTTSConfig
from models.experimental.miniCPMo.reference.configuration_minicpm import MiniCPMOConfig
from models.experimental.miniCPMo.reference.modeling_navit_siglip import SiglipVisionTransformer
from models.experimental.miniCPMo.reference.resampler import Resampler
...
def generate_position_embeddings(
    all_pixel_values, patch_size, num_patches_per_side, position_embedding_weight, patch_attn_mask, tgt_sizes, device
):
...
class TTMiniCPMO(MiniCPMOPreTrainedModel):
    ...
    def streaming_generate(
        ...
        **kwargs,
        ...
        input_ids = tokenizer(generate_prompt, return_tensors="pt", add_special_tokens=False)["input_ids"].to(
            self.device
        )
