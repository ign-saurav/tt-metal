...
def test_perf_device_bare_metal_3detr(batch_size, model_name, expected_perf):
    subdir = model_name
    num_iterations = 1
    margin = 0.04

    command = f"pytest models/experimental/detr3d/tests/pcc/test_ttnn_3detr.py::test_3detr_model"
