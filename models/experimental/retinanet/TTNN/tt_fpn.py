...
class resnet50Fpn:
    def __init__(
        ...
        self.conv1 = TTConv2D(
            ...
            stride=1,
            padding=0,
            parameters=getattr(parameters.inner_blocks, "0_0", None),
        ...
        self.conv2 = TTConv2D(
            ...
            stride=1,
            padding=0,
            parameters=getattr(parameters.inner_blocks, "1_0", None),
            kernel_fidelity=model_config,
            activation=None,
        ...
        self.conv3 = TTConv2D(
            ...
            stride=1,
            padding=0,
            parameters=getattr(parameters.inner_blocks, "2_0", None),
            kernel_fidelity=model_config,
            activation=None,
        ...
        self.conv4 = TTConv2D(
            ...
            stride=1,
            padding=1,
            parameters=getattr(parameters.layer_blocks, "0_0", None),
            kernel_fidelity=model_config,
            activation=None,
        ...
        self.conv5 = TTConv2D(
            ...
            stride=1,
            padding=1,
            parameters=getattr(parameters.layer_blocks, "1_0", None),
            kernel_fidelity=model_config,
            activation=None,
        ...
        self.conv6 = TTConv2D(
            ...
            stride=1,
            padding=1,
            parameters=getattr(parameters.layer_blocks, "2_0", None),
            kernel_fidelity=model_config,
            activation=None,
