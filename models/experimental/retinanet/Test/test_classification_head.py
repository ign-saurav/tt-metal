...
def test_classification_head_full(device, pcc, reset_seeds):
    ...
    from models.experimental.retinanet.TTNN.tt_classification_head import TTClassification

    # TTNN forward pass
    logger.info("Running TTNN forward pass")
    ttnn_model = TTClassification(ttnn_parameters, model_config, device)
    ttnn_output = ttnn_model(ttnn_features, device, input_shapes)
